package com.schmitz.jpaRepository.controllers;
...
import com.schmitz.jpaRepository.entities.User;
import com.schmitz.jpaRepository.repositories.UserRepository;
...
public class UserController {
	...
	@GetMapping(value = "/search-salary2")
	public ResponseEntity<Page<User>> searchBySalary2(
			@RequestParam(defaultValue = "0") Double minSalary, 
			@RequestParam(defaultValue = "1000000000000") Double maxSalary, 
			Pageable pageable) {
	...
	@GetMapping(value = "/search-name2")
	public ResponseEntity<Page<User>> searchByName2(
			@RequestParam(defaultValue = "") String name, 
			Pageable pageable) {
